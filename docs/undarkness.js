...
var ConstSet12 = setConstr(4, 0);
var ConstSet13 = setConstr(5);
var ConstSet14 = setConstr(4, 0);
...
function init_table_257034(initial_size_257038) {
	var result_257054 = {data: null, counter: 0};
		...
		result_257054.data = new Array(chckRange(initial_size_257038, 0, 2147483647)); for (var i=0;i<chckRange(initial_size_257038, 0, 2147483647);++i) {result_257054.data[i]={Field0: 0, Field1: null, Field2: {title: null, choices: null}};}
...
function init_ordered_table_229383(initial_size_229387) {
	var result_229389 = {data: null, counter: 0, first: 0, last: 0};
		...
		result_229389.data = new Array(chckRange(initial_size_229387, 0, 2147483647)); for (var i=0;i<chckRange(initial_size_229387, 0, 2147483647);++i) {result_229389.data[i]={Field0: 0, Field1: 0, Field2: null, Field3: null};}		result_229389.first = -1;
...
function enlarge_232167(t_232173) {
		var n_232181 = null;
		n_232181 = new Array(chckRange(mulInt((t_232173.data != null ? t_232173.data.length : 0), 2), 0, 2147483647)); for (var i=0;i<chckRange(mulInt((t_232173.data != null ? t_232173.data.length : 0), 2), 0, 2147483647);++i) {n_232181[i]={Field0: 0, Field1: 0, Field2: null, Field3: null};}		var h_232320 = t_232173.first;
		t_232173.first = -1;
		t_232173.last = -1;
...
function HEX5BHEX5DHEX3D_230311(t_230317, key_230318, val_230319) {
		...
		t_230317.counter = 0;
		t_230317.data = new Array(64); for (var i=0;i<64;++i) {t_230317.data[i]={Field0: 0, Field1: 0, Field2: null, Field3: null};}		t_230317.first = -1;
		t_230317.last = -1;
		}
...
function hash_175430(x_175432) {
	var result_175433 = 0;
		...
		L3: do {
			var i_175607 = 0;
			var colontmp__265105 = 0;
			colontmp__265105 = (x_175432 != null ? (x_175432.length-1) : -1);
			var res_265106 = i_175436;
			L4: do {
					L5: while (true) {
					if (!(res_265106 <= colontmp__265105)) break L5;
						i_175607 = res_265106;
						result_175433 = HEX21HEX26_174272(result_175433, hash_175069(x_175432.charCodeAt(chckIndx(i_175607, 0, x_175432.length+0-1)-0)));
						res_265106 = addInt(res_265106, 1);
					}
			} while(false);
		} while(false);
...
function enlarge_261348(t_261354) {
		var n_261362 = null;
		n_261362 = new Array(chckRange(mulInt((t_261354.data != null ? t_261354.data.length : 0), 2), 0, 2147483647)); for (var i=0;i<chckRange(mulInt((t_261354.data != null ? t_261354.data.length : 0), 2), 0, 2147483647);++i) {n_261362[i]={Field0: 0, Field1: null, Field2: {title: null, choices: null}};}		var Tmp1 = t_261354.data; t_261354.data = n_261362; n_261362 = Tmp1;		L2: do {
			var i_261521 = 0;
			var colontmp__265113 = 0;
			colontmp__265113 = (n_261362 != null ? (n_261362.length-1) : -1);
			var res_265114 = 0;
			L3: do {
					L4: while (true) {
					if (!(res_265114 <= colontmp__265113)) break L4;
						i_261521 = res_265114;
						...
						res_265114 = addInt(res_265114, 1);
					}
			} while(false);
		} while(false);
...
function nsuToLowerAsciiChar(c_158780) {
	var result_158781 = 0;
		...
		if ((ConstSet9[c_158780] != undefined)) {
		...
		L1: do {
				...
				if (!(i_167432 < (formatstr_167426 != null ? formatstr_167426.length : 0))) break L2;
					...
					case 45:
						...
						L3: do {
								L4: while (true) {
									if (!(i_167432 < (formatstr_167426 != null ? formatstr_167426.length : 0))) Tmp5 = false; else {										Tmp5 = (ConstSet6[formatstr_167426[chckIndx(i_167432, 0, formatstr_167426.length+0-1)-0]] != undefined);									}								if (!Tmp5) break L4;
					...
					case 123:
						...
						L8: do {
								L9: while (true) {
								if (!((j_167503 < (formatstr_167426 != null ? formatstr_167426.length : 0)) && !((ConstSet7[formatstr_167426[chckIndx(j_167503, 0, formatstr_167426.length+0-1)-0]] != undefined)))) break L9;
									if ((ConstSet8[formatstr_167426[chckIndx(j_167503, 0, formatstr_167426.length+0-1)-0]] != undefined)) {
					...
					case 95:
						...
						L13: do {
								L14: while (true) {
									if (!(j_167560 < (formatstr_167426 != null ? formatstr_167426.length : 0))) Tmp15 = false; else {										Tmp15 = (ConstSet10[formatstr_167426[chckIndx(j_167560, 0, formatstr_167426.length+0-1)-0]] != undefined);									}								if (!Tmp15) break L14;
...
function collection_to_string_257769(x_257772, prefix_257773, separator_257774, suffix_257775) {
	var result_257776 = [null];
		...
		L1: do {
			...
			L2: do {
					L3: while (true) {
					if (!(i_265131 <= 6)) break L3;
						if ((x_257772[i_265131] != undefined)) {
						value_257823 = i_265131;
...
function HEX5BHEX5D_239639(node_239641, name_239642) {
	...
	var result_239643 = null;
		...
		if (ConstSet13[Tmp1.kind]===undefined) { raiseFieldError(makeNimstrLit("fields")); }
...
function len_239483(n_239485) {
	...
	var result_239486 = 0;
		...
		case 6:
			var Tmp1 = n_239485;
			if (ConstSet18[Tmp1.kind]===undefined) { raiseFieldError(makeNimstrLit("elems")); }
			result_239486 = ((Tmp2 = Tmp1.elems, Tmp2) != null ? Tmp2.length : 0);
			break;
		case 5:
			var Tmp3 = n_239485;
			if (ConstSet19[Tmp3.kind]===undefined) { raiseFieldError(makeNimstrLit("fields")); }
...
function HEX5BHEX5D_240369(node_240371, index_240372) {
	...
	BeforeRet: do {
		if (!(!((node_240371 == null)))) {
		failed_assert_impl_15051(makeNimstrLit("json.nim(495, 9) `not isNil(node)` "));
		}
		
		if (!((node_240371.kind == 6))) {
		failed_assert_impl_15051(makeNimstrLit("json.nim(496, 9) `node.kind == JArray` "));
		}
		
		var Tmp1 = node_240371;
		if (ConstSet21[Tmp1.kind]===undefined) { raiseFieldError(makeNimstrLit("elems")); }
			...
			L2: do {
				...
				L4: do {
						...
						if (!(0 <= h_265062)) break L5;
							...
							if (!((ConstSet5[temp_257682.kind] != undefined))) {
							var msg_257754 = nsuFormatOpenArray(makeNimstrLit("Incorrect JSON kind. Wanted \'$1\' in \'$2\' but got \'$3\'."), [HEX24_257763(ConstSet11), makeNimstrLit("temp257682"), reprEnum(temp_257682.kind, NTI229202)]);
							var e_258266 = null;
							...
							if (!((ConstSet12[HEX5BHEX5D_239639(temp_257682, makeNimstrLit("title")).kind] != undefined))) {
							var msg_258410 = nsuFormatOpenArray(makeNimstrLit("Incorrect JSON kind. Wanted \'$1\' in \'$2\' but got \'$3\'."), [HEX24_257763(ConstSet14), makeNimstrLit("temp257682[\"title\"]"), reprEnum(HEX5BHEX5D_239639(temp_257682, makeNimstrLit("title")).kind, NTI229202)]);
							var e_258430 = null;
							...
							Tmp6 = [];
								...
								if (ConstSet15[Tmp7.kind]===undefined) { raiseFieldError(makeNimstrLit("str")); }
							Tmp6 = Tmp7.str;
							}
							
							res_257751.title = nimCopy(null, Tmp6, NTI138);
							var list_257740 = [];
							if (!((ConstSet16[HEX5BHEX5D_239639(temp_257682, makeNimstrLit("choices")).kind] != undefined))) {
							var msg_258630 = nsuFormatOpenArray(makeNimstrLit("Incorrect JSON kind. Wanted \'$1\' in \'$2\' but got \'$3\'."), [HEX24_257763(ConstSet17), makeNimstrLit("temp257682[\"choices\"]"), reprEnum(HEX5BHEX5D_239639(temp_257682, makeNimstrLit("choices")).kind, NTI229202)]);
							var e_258650 = null;
							...
							L8: do {
								...
								L9: do {
										...
										if (!(i_265047 < colontmp__265046)) break L10;
											i_257731 = i_265047;
											if (!((ConstSet20[HEX5BHEX5D_240369(HEX5BHEX5D_239639(temp_257682, makeNimstrLit("choices")), i_257731).kind] != undefined))) {
											var msg_258818 = nsuFormatOpenArray(makeNimstrLit("Incorrect JSON kind. Wanted \'$1\' in \'$2\' but got \'$3\'."), [HEX24_257763(ConstSet22), makeNimstrLit("temp257682[\"choices\"][i257731]"), reprEnum(HEX5BHEX5D_240369(HEX5BHEX5D_239639(temp_257682, makeNimstrLit("choices")), i_257731).kind, NTI229202)]);
											var e_258838 = null;
											...
											if (!((ConstSet23[HEX5BHEX5D_239639(HEX5BHEX5D_240369(HEX5BHEX5D_239639(temp_257682, makeNimstrLit("choices")), i_257731), makeNimstrLit("response")).kind] != undefined))) {
											var msg_259010 = nsuFormatOpenArray(makeNimstrLit("Incorrect JSON kind. Wanted \'$1\' in \'$2\' but got \'$3\'."), [HEX24_257763(ConstSet24), makeNimstrLit("temp257682[\"choices\"][i257731][\"response\"]"), reprEnum(HEX5BHEX5D_239639(HEX5BHEX5D_240369(HEX5BHEX5D_239639(temp_257682, makeNimstrLit("choices")), i_257731), makeNimstrLit("response")).kind, NTI229202)]);
											var e_259030 = null;
											...
											Tmp11 = [];
												...
												if (ConstSet25[Tmp12.kind]===undefined) { raiseFieldError(makeNimstrLit("str")); }
											Tmp11 = Tmp12.str;
											}
											
											res_257752.response = nimCopy(null, Tmp11, NTI138);
											if (!((ConstSet26[HEX5BHEX5D_239639(HEX5BHEX5D_240369(HEX5BHEX5D_239639(temp_257682, makeNimstrLit("choices")), i_257731), makeNimstrLit("path")).kind] != undefined))) {
											var msg_259216 = nsuFormatOpenArray(makeNimstrLit("Incorrect JSON kind. Wanted \'$1\' in \'$2\' but got \'$3\'."), [HEX24_257763(ConstSet27), makeNimstrLit("temp257682[\"choices\"][i257731][\"path\"]"), reprEnum(HEX5BHEX5D_239639(HEX5BHEX5D_240369(HEX5BHEX5D_239639(temp_257682, makeNimstrLit("choices")), i_257731), makeNimstrLit("path")).kind, NTI229202)]);
											var e_259236 = null;
											...
											Tmp13 = [];
												...
												if (ConstSet28[Tmp14.kind]===undefined) { raiseFieldError(makeNimstrLit("str")); }
											Tmp13 = Tmp14.str;
											}
...
function new_seq_197612(len_197615) {
	var result_197617 = null;
		...
		result_197617 = new Array(len_197615); for (var i=0;i<len_197615;++i) {result_197617[i]={k: 0, parent: null, current: null, newNode: null, oldNode: null};}
...
function new_seq_197649(len_197652) {
	var result_197654 = null;
		...
		result_197654 = new Array(len_197652); for (var i=0;i<len_197652;++i) {result_197654[i]={parent: null, newChild: null, pos: 0};}
...
function apply_events_190086(n_190088) {
		...
		L1: do {
			var i_190102 = 0;
			var colontmp__265163 = 0;
			colontmp__265163 = (n_190088.events != null ? n_190088.events.length : 0);
			var i_265164 = 0;
			L2: do {
					L3: while (true) {
					if (!(i_265164 < colontmp__265163)) break L3;
						i_190102 = i_265164;
...
function apply_style_58025(n_58027, s_58028) {
		...
		L1: do {
			var i_58221 = 0;
			var colontmp__265175 = 0;
			colontmp__265175 = subInt(s_58028.length, 1);
			var res_265176 = 0;
			L2: do {
					L3: while (true) {
					if (!(res_265176 <= colontmp__265175)) break L3;
						i_58221 = res_265176;
						n_58027.style[s_58028[i_58221]] = s_58028[addInt(i_58221, 1)];
						res_265176 = addInt(res_265176, 2);
					}
			} while(false);
		} while(false);
...
function to_dom_190167(n_190169, use_attached_node_190170, kxi_190171) {
	...
	BeforeRet: do {
		...
		failed_assert_impl_15051(makeNimstrLit("karax.nim(156, 12) `result != nil` "));
		}
		...
		failed_assert_impl_15051(makeNimstrLit("karax.nim(163, 12) `x.renderImpl != nil` "));
		}
		...
		if (!(!((x_190422.expanded == null)))) {
		failed_assert_impl_15051(makeNimstrLit("karax.nim(167, 12) `x.expanded != nil` "));
		}
		...
		break BeforeRet;
			...
			L1: do {
				...
				L2: do {
					var i_265143 = 0;
					var colontmp__265144 = 0;
					colontmp__265144 = (n_190169.kids != null ? n_190169.kids.length : 0);
					var i_265145 = 0;
					L3: do {
							L4: while (true) {
							if (!(i_265145 < colontmp__265144)) break L4;
								i_265143 = i_265145;
								k_190831 = n_190169.kids[chckIndx(i_265143, 0, n_190169.kids.length+0-1)-0];
								result_190172.appendChild(to_dom_190167(k_190831, use_attached_node_190170, kxi_190171));
								i_265145 = addInt(i_265145, 1);
							}
					} while(false);
				} while(false);
			} while(false);
		...
		L5: do {
			...
			L6: do {
				var i_265156 = 0;
				var colontmp__265157 = 0;
				colontmp__265157 = subInt((n_190169.attrs != null ? n_190169.attrs.length : 0), 2);
				var res_265158 = 0;
				L7: do {
						L8: while (true) {
						if (!(res_265158 <= colontmp__265157)) break L8;
							i_265156 = res_265158;
							k_190832 = n_190169.attrs[chckIndx(i_265156, 0, n_190169.attrs.length+0-1)-0];
							v_190833 = n_190169.attrs[chckIndx(addInt(i_265156, 1), 0, n_190169.attrs.length+0-1)-0];
							if (!((v_190833 == null))) {
							result_190172.setAttribute(k_190832, v_190833);
							}
							
							res_265158 = addInt(res_265158, 2);
						}
				} while(false);
			} while(false);
		} while(false);
...
function same_190920(n_190922, e_190923, nesting_190924) {
	...
	BeforeRet: do {
		...
		L3: do {
			var i_190994 = 0;
			var colontmp__265182 = 0;
			colontmp__265182 = len_170742(n_190922);
			var i_265183 = 0;
			L4: do {
					L5: while (true) {
					if (!(i_265183 < colontmp__265182)) break L5;
						i_190994 = i_265183;
...
function eq_56814(a_56816, b_56817) {
	...
	BeforeRet: do {
		...
		L1: do {
			var i_56916 = 0;
			var colontmp__265225 = 0;
			colontmp__265225 = a_56816.length;
			var i_265226 = 0;
			L2: do {
					L3: while (true) {
					if (!(i_265226 < colontmp__265225)) break L3;
						i_56916 = i_265226;
...
function same_attrs_172680(a_172682, b_172683) {
	...
	BeforeRet: do {
		...
		L1: do {
			var i_172707 = 0;
			var colontmp__265230 = 0;
			colontmp__265230 = (a_172682.attrs != null ? a_172682.attrs.length : 0);
			var i_265231 = 0;
			L2: do {
					L3: while (true) {
					if (!(i_265231 < colontmp__265230)) break L3;
						i_172707 = i_265231;
...
function eq_191214(a_191216, b_191217, recursive_191218) {
	...
	BeforeRet: do {
		...
		L1: do {
			var i_192014 = 0;
			var colontmp__265215 = 0;
			colontmp__265215 = len_170742(a_191216);
			var i_265216 = 0;
			L2: do {
					L3: while (true) {
					if (!(i_265216 < colontmp__265215)) break L3;
						i_192014 = i_265216;
		...
		L6: do {
			var i_192608 = 0;
			var colontmp__265220 = 0;
			colontmp__265220 = len_170742(a_191216);
			var i_265221 = 0;
			L7: do {
					L8: while (true) {
					if (!(i_265221 < colontmp__265220)) break L8;
						i_192608 = i_265221;
...
function update_attributes_192690(new_node_192692, old_node_192693) {
		...
		L1: do {
			...
			L2: do {
				...
				colontmp__265238 = subInt((old_node_192693.attrs != null ? old_node_192693.attrs.length : 0), 2);
				var res_265239 = 0;
				L3: do {
						L4: while (true) {
						if (!(res_265239 <= colontmp__265238)) break L4;
							i_265237 = res_265239;
							k_192702 = old_node_192693.attrs[chckIndx(i_265237, 0, old_node_192693.attrs.length+0-1)-0];
							__192703 = old_node_192693.attrs[chckIndx(addInt(i_265237, 1), 0, old_node_192693.attrs.length+0-1)-0];
							old_node_192693.dom.removeAttribute(k_192702);
							res_265239 = addInt(res_265239, 2);
						}
				} while(false);
			} while(false);
		} while(false);
		L5: do {
			...
			L6: do {
				var i_265245 = 0;
				var colontmp__265246 = 0;
				colontmp__265246 = subInt((new_node_192692.attrs != null ? new_node_192692.attrs.length : 0), 2);
				var res_265247 = 0;
				L7: do {
						L8: while (true) {
						if (!(res_265247 <= colontmp__265246)) break L8;
							i_265245 = res_265247;
							k_192704 = new_node_192692.attrs[chckIndx(i_265245, 0, new_node_192692.attrs.length+0-1)-0];
							v_192705 = new_node_192692.attrs[chckIndx(addInt(i_265245, 1), 0, new_node_192692.attrs.length+0-1)-0];
							if (!((v_192705 == null))) {
							old_node_192693.dom.setAttribute(k_192704, v_192705);
							}
							
							res_265247 = addInt(res_265247, 2);
						}
				} while(false);
			} while(false);
		} while(false);
...
function diff_193245(new_node_193247, old_node_193248, parent_193249, current_193250, kxi_193251) {
	...
	BeforeRet: do {
		...
		case 2:
			...
			failed_assert_impl_15051(makeNimstrLit("karax.nim(457, 12) `oldNode.kind == newNode.kind` "));
			}
			...
			L6: do {
				var i_193639 = 0;
				var colontmp__265190 = 0;
				colontmp__265190 = subInt(pos_193633, 1);
				var res_265191 = common_prefix_193602;
				L7: do {
						L8: while (true) {
						if (!(res_265191 <= colontmp__265190)) break L8;
							i_193639 = res_265191;
							...
							res_265191 = addInt(res_265191, 1);
						}
				} while(false);
			} while(false);
			...
			L15: do {
				var i_193658 = 0;
				var res_265209 = pos_193633;
				L16: do {
						L17: while (true) {
						if (!(res_265209 <= old_pos_193614)) break L17;
							i_193658 = res_265209;
							...
							res_265209 = addInt(res_265209, 1);
						}
				} while(false);
			} while(false);
			break;
		...
		case 4:
			if (true) {
			failed_assert_impl_15051(makeNimstrLit("karax.nim(499, 26) `false` eq returned usenewNode"));
			}
...
function move_dom_192907(dest_192909, src_192910) {
		...
		failed_assert_impl_15051(makeNimstrLit("karax.nim(363, 10) `dest.len == src.len` "));
		}
		
		L1: do {
			var i_193008 = 0;
			var colontmp__265264 = 0;
			colontmp__265264 = len_170742(dest_192909);
			var i_265265 = 0;
			L2: do {
					L3: while (true) {
					if (!(i_265265 < colontmp__265264)) break L3;
						i_193008 = i_265265;
						move_dom_192907(HEX5BHEX5D_170764(dest_192909, i_193008), HEX5BHEX5D_170764(src_192910, i_193008));
						i_265265 = addInt(i_265265, 1);
					}
			} while(false);
		} while(false);
...
function apply_patch_193022(kxi_193024) {
		L1: do {
			...
			colontmp__265254 = kxi_193024.patchLen;
			var i_265255 = 0;
			L2: do {
					L3: while (true) {
		...
		L4: do {
			var i_193076 = 0;
			var colontmp__265259 = 0;
			colontmp__265259 = kxi_193024.patchLenV;
			var i_265260 = 0;
			L5: do {
					L6: while (true) {
					if (!(i_265260 < colontmp__265259)) break L6;
						i_193076 = i_265260;
						...
						failed_assert_impl_15051(makeNimstrLit("karax.nim(399, 12) `p.newChild.dom != nil` "));
						}
						
						i_265260 = addInt(i_265260, 1);
					}
			} while(false);
		} while(false);
...
function dodraw_196046(kxi_196048) {
	BeforeRet: do {
		...
		replace_by_id_191012(kxi_196048.rootId, asdom_196069);
			...
			failed_assert_impl_15051(makeNimstrLit("karax.nim(606, 14) `same(kxi.currentTree, document.getElementById(kxi.rootId))` "));
			}
		...
		if (!(same_190920(kxi_196048.currentTree, document.getElementById(kxi_196048.rootId), 0))) {
		failed_assert_impl_15051(makeNimstrLit("karax.nim(619, 12) `same(kxi.currentTree, document.getElementById(kxi.rootId))` "));
		}
...
function tree_172246(kind_172248, kids_172250) {
	var result_172251 = null;
		...
		L1: do {
			...
			L2: do {
					L3: while (true) {
					if (!(i_265281 < (kids_172250 != null ? kids_172250.length : 0))) break L3;
						k_172282 = kids_172250[chckIndx(i_265281, 0, kids_172250.length+0-1)-0];
						add_170800(result_172251, k_172282);
						i_265281 = addInt(i_265281, 1);
					}
			} while(false);
		} while(false);
...
function set_attr_170568(n_170570, key_170571, val_170572) {
	BeforeRet: do {
		...
		n_170570.attrs = nimCopy(null, [key_170571, val_170572], NTI170587);
			...
			L1: do {
				var i_170600 = 0;
				var colontmp__265293 = 0;
				colontmp__265293 = subInt((n_170570.attrs != null ? n_170570.attrs.length : 0), 2);
				var res_265294 = 0;
				L2: do {
						L3: while (true) {
						if (!(res_265294 <= colontmp__265293)) break L3;
							i_170600 = res_265294;
							...
							res_265294 = addInt(res_265294, 2);
						}
				} while(false);
			} while(false);
...
function render_choices_255114(choices_255117) {
						...
						function HEX3Aanonymous_255161(ev_255163, n_255164) {
								L1: do {
									var btn_255214 = null;
									var colontmp__265301 = null;
									colontmp__265301 = document.querySelectorAll(".buttons .button");
									var i_265303 = 0;
									var l_265304 = (colontmp__265301 != null ? colontmp__265301.length : 0);
									L2: do {
											L3: while (true) {
											if (!(i_265303 < l_265304)) break L3;
												btn_255214 = colontmp__265301[chckIndx(i_265303, 0, colontmp__265301.length+0-1)-0];
												btn_255214.blur();
												i_265303 = addInt(i_265303, 1);
												if (!(((colontmp__265301 != null ? colontmp__265301.length : 0) == l_265304))) {
	...
	var result_255118 = null;
		...
		L1: do {
			...
			L2: do {
					L3: while (true) {
					if (!(i_265290 < (choices_255117 != null ? choices_255117.length : 0))) break L3;
						nimCopy(choice_255155, choices_255117[chckIndx(i_265290, 0, choices_255117.length+0-1)-0], NTI255111);
